  ...
  <div class="container h-100">
        <div class="row p-5 h-100 justify-content-center align-items-center">
          ...
          <div class="col-md-6">
            ...
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit.  Nihil voluptas vitae veritatis magnam reprehenderit, reiciendis ex? Libero quasi natus veniam voluptatum, voluptas exercitationem ratione consectetur et!
            </p>
...
<footer class="page-footer">
  <div class="container">
    ...
    <div class="row">
      ...
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.  Sed aliquet dolor id sapien rutrum, id vulputate quam iaculis.</p>
    </div>
